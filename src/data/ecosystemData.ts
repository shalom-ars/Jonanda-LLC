...
export const ECOSYSTEM_PRODUCTS: EcosystemProduct[] = [
  ...
  {
    id: 'jonanda-security',
    name: 'JONANDA Security Engineering',
    category: 'Cybersecurity & Defensive Systems',
    tagline: 'Defensive security technology and vulnerability analysis',
    description: 'JONANDA security frameworks deliver digital vulnerability analysis, threat modeling, and defensive cyber technology for modern software systems.',
    fullDescription: 'Engineered to protect mission-critical digital assets and infrastructure, combining automated security diagnostics with rigorous verification methodologies to help organizations harden cloud perimeters.',
    capabilities: [
