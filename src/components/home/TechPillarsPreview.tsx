...
export const TechPillarsPreview: React.FC = () => {
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 relative z-10 bg-background-subtle/50">
            ...
            return (
              ...
              >
                <div className="space-y-4">
                  <div className="w-12 h-12 rounded-xl bg-gold-500/10 border border-gold-500/25 flex items-center justify-center text-gold-400">
                ...
                <div className="pt-6 mt-4 border-t border-white/[0.06] flex items-center justify-between">
                  ...
                  <Button
                    ...
                    variant="ghost"
                    size="sm"
                    className="text-gold-400 hover:text-gold-300 p-0 hover:bg-transparent"
