...
export const Hero: React.FC = () => {
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[350px] bg-gold-500/10 rounded-full blur-[120px] pointer-events-none" />

      <div className="max-w-5xl mx-auto text-center relative z-10 space-y-8">
        {/* Brand Badge */}
        <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-gold-500/10 dark:bg-gold-500/10 border border-amber-500/30 dark:border-gold-500/30 text-xs sm:text-sm font-medium text-amber-700 dark:text-gold-300 shadow-sm dark:shadow-gold-sm backdrop-blur-md">
        ...
        <div className="pt-12 grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 max-w-4xl mx-auto">
          <div className="flex items-center gap-2.5 p-3 rounded-xl bg-slate-100 dark:bg-white/[0.04] border border-gray-200 dark:border-white/[0.08] shadow-sm dark:shadow-none backdrop-blur-sm">
            <div className="w-8 h-8 rounded-lg bg-gold-500/10 border border-gold-500/20 flex items-center justify-center text-amber-600 dark:text-gold-400 shrink-0">
              <Cpu className="w-4 h-4" />
            </div>
            <div className="text-left">
              <div className="text-xs font-bold text-gray-900 dark:text-white">Artificial Intelligence</div>
              <div className="text-[10px] text-gray-600 dark:text-gray-400">Intelligent Systems</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2.5 p-3 rounded-xl bg-slate-100 dark:bg-white/[0.04] border border-gray-200 dark:border-white/[0.08] shadow-sm dark:shadow-none backdrop-blur-sm">
            ...
            <div className="text-left">
              ...
              <div className="text-[10px] text-gray-600 dark:text-gray-400">Decentralized Protocols</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2.5 p-3 rounded-xl bg-slate-100 dark:bg-white/[0.04] border border-gray-200 dark:border-white/[0.08] shadow-sm dark:shadow-none backdrop-blur-sm">
            ...
            <div className="text-left">
              ...
              <div className="text-[10px] text-gray-600 dark:text-gray-400">Threat Defense</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2.5 p-3 rounded-xl bg-slate-100 dark:bg-white/[0.04] border border-gray-200 dark:border-white/[0.08] shadow-sm dark:shadow-none backdrop-blur-sm">
            ...
            <div className="text-left">
              ...
              <div className="text-[10px] text-gray-600 dark:text-gray-400">Digital Infrastructure</div>
            </div>
          </div>
        </div>
      </div>
