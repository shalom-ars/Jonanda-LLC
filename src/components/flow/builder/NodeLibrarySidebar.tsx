  ...
  return (
    ...
    >
        ...
        <div className="p-4 border-b border-gray-200 dark:border-white/10 space-y-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-8 pr-3 py-1.5 rounded-lg bg-gray-100 dark:bg-[#141420] border border-gray-300 dark:border-white/10 text-xs text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-amber-500"
            />
          </div>
          ...
          {filteredNodes.map((def) => {
            ...
            return (
              <div
                ...
                className={`
                  p-2.5 rounded-xl bg-gray-50 dark:bg-[#12121c] border border-gray-200 dark:border-white/[0.06]
                  hover:bg-white dark:hover:bg-[#161622] transition-all cursor-pointer group shadow-sm flex items-start justify-between gap-2.5
                  ${categoryBorder}
                `}
              >
                ...
                <button
                  type="button"
                  title="Add to canvas"
                  className="p-1 rounded bg-gray-200 dark:bg-white/5 group-hover:bg-amber-500 group-hover:text-white text-gray-500 dark:text-gray-400 transition-colors shrink-0"
                >
      ...
      <button
        type="button"
        onClick={onToggle}
        className="self-center -mr-3 z-30 p-1.5 rounded-r-lg bg-white dark:bg-[#12121c] border border-l-0 border-gray-200 dark:border-white/10 text-gray-500 hover:text-amber-600 dark:hover:text-gold-400 shadow-md"
