    ...
    <>
      ...
      <div className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-24 relative z-10">
                    ...
                    <div className="space-y-2 pt-2 border-t border-white/[0.06]">
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {prog.idealFor.map((item, iIdx) => (
                          <span
                            key={iIdx}
                            className="text-[10px] px-2 py-0.5 rounded bg-background/80 border border-white/[0.08] text-gray-300"
                          >
                            {item}
                          </span>
                        ))}
        ...
        <section id="partner-inquiry" className="space-y-8">
          ...
          <div className="rounded-3xl bg-surface/80 border border-white/[0.08] p-6 sm:p-10 lg:p-12 shadow-2xl relative backdrop-blur-xl max-w-4xl mx-auto">
            {formStatus === 'success' ? (
              <div className="text-center py-12 space-y-6 max-w-xl mx-auto">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-sm sm:text-base text-gray-300 leading-relaxed">
                    Thank you for your interest in collaborating with <strong>JONANDA LLC</strong>. Our strategic partnerships team will review your proposal and respond via email at <span className="text-white font-semibold">{partnerForm.email}</span> within 2 business days.
                  </p>
                </div>

                <div className="p-4 rounded-xl bg-background/60 border border-white/[0.06] text-xs text-gray-400 text-left space-y-1">
                  <p className="text-gray-300 font-semibold">Direct Corporate Alliances:</p>
                  <p>You can also reach our partnership office at <a href="mailto:contact@jonanda.com" className="text-gold-300 hover:underline">contact@jonanda.com</a> quoting reference <span className="font-mono text-white">{refId}</span>.</p>
                </div>
